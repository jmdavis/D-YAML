...
void extract(ref Node document)
{
    void crawl(ref Node root)
    {
        ...
        {
            case "tag:yaml.org,2002:null":      root.as!YAMLNull;  break;
            case "tag:yaml.org,2002:bool":      root.as!bool;      break;
            case "tag:yaml.org,2002:int":       root.as!long;      break;
            case "tag:yaml.org,2002:float":     root.as!real;      break;
            case "tag:yaml.org,2002:binary":    root.as!(ubyte[]); break;
            case "tag:yaml.org,2002:timestamp": root.as!SysTime;   break;
            case "tag:yaml.org,2002:str":       root.as!string;    break;
